...
CREATE TABLE IF NOT EXISTS `crm_lead` (
  ...
  `rating` VARCHAR(10) DEFAULT NULL COMMENT '评级: A-高, B-中, C-低, D-极低',
...
CREATE TABLE `crm_customer` (
  ...
  `lead_id` bigint(20) DEFAULT NULL COMMENT '来源线索ID',
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '状态: 1-正常, 2-公海',
